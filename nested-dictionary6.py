...
<SurfaceTemperatureFahrenheit>63.9</SurfaceTemperatureFahrenheit>
<SurfaceDewpointTemperatureFahrenheit>60.6</SurfaceDewpointTemperatureFahrenheit>
</Hour>
    ...
    for record in root.iter():
        ...
        if record.tag == 'Hour':
            ...
            if record.tag == 'SurfaceTemperatureFahrenheit':
                if 'obs' in site_data[site_id]:
                    site_data[site_id]['obs'][valid_time] = {'SurfaceTemperatureFahrenheit':record.text}
                else:
                    site_data[site_id]['obs'] = {valid_time : {'SurfaceTemperatureFahrenheit':record.text}}
