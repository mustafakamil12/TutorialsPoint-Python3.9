...
function v(a,b){a.prototype=ha(b.prototype);a.prototype.constructor=a;if(ma)ma(a,b);else for(var c in b)if("prototype"!=c)if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.L=b.prototype}
function oa(){this.u=!1;this.l=null;this.i=void 0;this.h=1;this.m=this.o=0;this.H=this.j=null}
function pa(a){if(a.u)throw new TypeError("Generator is already running");a.u=!0}
oa.prototype.v=function(a){this.i=a};
function qa(a,b){a.j={Ca:b,Ga:!0};a.h=a.o||a.m}
...
function sa(a){a.o=0;var b=a.j.Ca;a.j=null;return b}
function ta(a){a.H=[a.j];a.o=0;a.m=0}
function ua(a){var b=a.H.splice(0)[0];(b=a.j=a.j||b)?b.Ga?a.h=a.o||a.m:void 0!=b.s&&a.m<b.s?(a.h=b.s,a.j=null):a.h=a.m:a.h=0}
...
function ya(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.u=!1,{value:b.value,done:!1}}catch(c){a.h.i=void 0,qa(a.h,c)}a.h.u=!1;if(a.h.j){b=a.h.j;a.h.j=null;if(b.Ga)throw b.Ca;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
function d(h,k){var l=k&&typeof k;"object"==l||"function"==l?f.has(k)?l=f.get(k):(l=""+ ++g,f.set(k,l)):l="p_"+k;var m=h.data_[l];if(m&&Aa(h.data_,l))for(h=0;h<m.length;h++){var q=m[h];if(k!==k&&q.key!==q.key||k===q.key)return{id:l,list:m,index:h,C:q}}return{id:l,list:m,index:-1,C:void 0}}
function e(h){this.data_={};this.h=b();this.size=0;if(h){h=u(h);for(var k;!(k=h.next()).done;)k=k.value,this.set(k[0],k[1])}}
if(function(){if(!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var h=Object.seal({x:4}),k=new a(u([[h,"s"]]));if("s"!=k.get(h)||1!=k.size||k.get({x:4})||k.set({x:4},"t")!=k||2!=k.size)return!1;var l=k.entries(),m=l.next();if(m.done||m.value[0]!=h||"s"!=m.value[1])return!1;m=l.next();return m.done||4!=m.value[0].x||"t"!=m.value[1]||!l.next().done?!1:!0}catch(q){return!1}}())return a;
var f=new WeakMap;e.prototype.set=function(h,k){h=0===h?0:h;var l=d(this,h);l.list||(l.list=this.data_[l.id]=[]);l.C?l.C.value=k:(l.C={next:this.h,previous:this.h.previous,head:this.h,key:h,value:k},l.list.push(l.C),this.h.previous.next=l.C,this.h.previous=l.C,this.size++);return this};
e.prototype.delete=function(h){h=d(this,h);return h.C&&h.list?(h.list.splice(h.index,1),h.list.length||delete this.data_[h.id],h.C.previous.next=h.C.next,h.C.next.previous=h.C.previous,h.C.head=null,this.size--,!0):!1};
...
var h=this,k=!1;return{resolve:g(this.Ua),reject:g(this.m)}};
b.prototype.Ua=function(g){if(g===this)this.m(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.Wa(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.na(g):this.o(g)}};
b.prototype.na=function(g){var h=void 0;try{h=g.then}catch(k){this.m(k);return}"function"==typeof h?this.Xa(h,g):this.o(g)};
b.prototype.m=function(g){this.v(2,g)};
b.prototype.o=function(g){this.v(1,g)};
b.prototype.v=function(g,h){if(0!=this.h)throw Error("Cannot settle("+g+", "+h+"): Promise already settled in state"+this.h);this.h=g;this.j=h;2===this.h&&this.Va();this.H()};
...
var r=[],p=0;do r.push(void 0),p++,d(k.value).fa(q(r.length-1),m),k=h.next();while(!k.done)})};
return b});
...
c.prototype=b.prototype;a.L=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Fb=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
function Na(a){return a}
;function Oa(a,b){if(Error.captureStackTrace)Error.captureStackTrace(this,Oa);else{var c=Error().stack;c&&(this.stack=c)}a&&(this.message=String(a));void 0!==b&&(this.ab=b)}
...
;var Bb={};function Cb(a,b,c){this.h=c===Bb?a:"";this.i=b;this.aa=this.Fa=!0}
Cb.prototype.Da=function(){return this.i};
...
return a}
var sc={sb:"allow-forms",tb:"allow-modals",ub:"allow-orientation-lock",vb:"allow-pointer-lock",wb:"allow-popups",xb:"allow-popups-to-escape-sandbox",yb:"allow-presentation",zb:"allow-same-origin",Ab:"allow-scripts",Bb:"allow-top-navigation",Cb:"allow-top-navigation-by-user-activation"},uc=Qa(function(){return tc()});
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,m;a();return{reset:a,update:c,digest:d,cb:function(){for(var q=d(),r="",p=0;p<q.length;p++)r+="0123456789ABCDEF".charAt(Math.floor(q[p]/16))+"0123456789ABCDEF".charAt(q[p]%16);return r}}}
...
function Bc(a){var b=yc();b.update(a);return b.cb().toLowerCase()}
;var Cc={};function Dc(a){this.h=a||{cookie:""}}
n=Dc.prototype;n.isEnabled=function(){if(!A.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{qa:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
n.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Kb;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.qa}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
n.remove=function(a,b,c){var d=void 0!==this.get(a);this.set(a,"",{qa:0,path:b,domain:c});return d};
...
if("undefined"!==typeof a&&!I("Trident")&&!I("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var e=c.za;c.za=null;e()}};
return function(e){d.next={za:e};d=d.next;b.port2.postMessage(0)}}return function(e){A.setTimeout(e,0)}}
...
function dd(a,b){b||(b={});b[fd(a)]=!0;var c=a.stack||"";(a=a.ab)&&!b[fd(a)]&&(c+="\nCaused by: ",a.stack&&0==a.stack.indexOf(a.toString())||(c+="string"===typeof a?a:a.message+"\n"),c+=dd(a,b));return c}
...
gd.prototype.Y=function(){if(this.m)for(;this.m.length;)this.m.shift()()};var hd="StopIteration"in A?A.StopIteration:{message:"StopIteration",stack:""};function id(){}
id.prototype.next=function(){return id.prototype.h.call(this)};
id.prototype.h=function(){throw hd;};
id.prototype.I=function(){return this};function jd(a){if(a instanceof kd||a instanceof ld||a instanceof md)return a;if("function"==typeof a.next)return new kd(function(){return nd(a)});
if("function"==typeof a[Symbol.iterator])return new kd(function(){return a[Symbol.iterator]()});
if("function"==typeof a.I)return new kd(function(){return nd(a.I())});
...
n.keys=function(){return jd(this.I(!0)).i()};
n.values=function(){return jd(this.I(!1)).i()};
n.entries=function(){var a=this;return Zc(this.keys(),function(b){return[b,a.get(b)]})};
n.I=function(a){qd(this);var b=0,c=this.j,d=this,e=new id;e.h=function(){if(c!=d.j)throw Error("The map has changed since the iterator was created");if(b>=d.h.length)throw hd;var f=d.h[b++];return a?f:d.i[f]};
...
this.i=a;a.defaultPrevented&&vd.L.preventDefault.call(this)};
vd.prototype.stopPropagation=function(){vd.L.stopPropagation.call(this);this.i.stopPropagation?this.i.stopPropagation():this.i.cancelBubble=!0};
vd.prototype.preventDefault=function(){vd.L.preventDefault.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var xd="closure_listenable_"+(1E6*Math.random()|0);var yd=0;function zd(a,b,c,d,e){this.listener=a;this.h=null;this.src=b;this.type=c;this.capture=!!d;this.ja=e;this.key=++yd;this.ba=this.ea=!1}
function Ad(a){a.ba=!0;a.listener=null;a.h=null;a.src=null;a.ja=null}
...
;var Ed="closure_lm_"+(1E6*Math.random()|0),Fd={},Gd=0;function Hd(a,b,c,d,e){if(d&&d.once)Id(a,b,c,d,e);else if(Array.isArray(b))for(var f=0;f<b.length;f++)Hd(a,b[f],c,d,e);else c=Jd(c),a&&a[xd]?a.W(b,c,C(d)?!!d.capture:!!d,e):Kd(a,b,c,!1,d,e)}
...
function Qd(a){if("number"!==typeof a&&a&&!a.ba){var b=a.src;if(b&&b[xd])Dd(b.h,a);else{var c=a.type,d=a.h;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(Nd(c),d):b.addListener&&b.removeListener&&b.removeListener(d);Gd--;(c=Ld(b))?(Dd(c,a),0==c.h&&(c.src=null,b[Ed]=null)):Ad(a)}}}
...
return a[Rd]}
;function M(){gd.call(this);this.h=new Bd(this);this.na=this;this.u=null}
...
function Sd(a,b){var c=a.u;if(c){var d=[];for(var e=1;c;c=c.u)d.push(c),++e}a=a.na;c=b.type||b;"string"===typeof b?b=new td(b,a):b instanceof td?b.target=b.target||a:(e=b,b=new td(c,a),cb(b,e));e=!0;if(d)for(var f=d.length-1;!b.j&&0<=f;f--){var g=b.h=d[f];e=Td(g,c,!0,b)&&e}b.j||(g=b.h=a,e=Td(g,c,!0,b)&&e,b.j||(e=Td(g,c,!1,b)&&e));if(d)for(f=0;!b.j&&f<d.length;f++)g=b.h=d[f],e=Td(g,c,!1,b)&&e}
M.prototype.Y=function(){M.L.Y.call(this);if(this.h){var a=this.h,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,Ad(d[e]);delete a.listeners[c];a.h--}}this.u=null};
M.prototype.W=function(a,b,c,d){return this.h.add(String(a),b,!1,c,d)};
...
Vd.prototype.H=function(a){this.h=0;Wd(this,2,a)};
...
n.da=function(a){var b=this.h[a];if(b){var c=this.i[b];0!=this.o?(this.l.push(a),this.h[a+1]=Ea):(c&&Ta(c,a),delete this.h[a],delete this.h[a+1],delete this.h[a+2])}return!!b};
n.X=function(a,b){var c=this.i[a];if(c){for(var d=Array(arguments.length-1),e=1,f=arguments.length;e<f;e++)d[e-1]=arguments[e];if(this.v)for(e=0;e<c.length;e++){var g=c[e];me(this.h[g+1],this.h[g+2],d)}else{this.o++;try{for(e=0,f=c.length;e<f&&!this.j;e++)g=c[e],this.h[g+1].apply(this.h[g+2],d)}finally{if(this.o--,0<this.l.length&&0==this.o)for(;c=this.l.pop();)this.da(c)}}return 0!=e}return!1};
...
n.Y=function(){N.L.Y.call(this);this.clear();this.l.length=0};function ne(a){this.h=a}
...
oe.prototype.set=function(a,b){oe.L.set.call(this,a,qe(b))};
oe.prototype.i=function(a){a=oe.L.get.call(this,a);if(void 0===a||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
...
F(re,oe);re.prototype.set=function(a,b,c){if(b=qe(b)){if(c){if(c<Date.now()){re.prototype.remove.call(this,a);return}b.expiration=c}b.creation=Date.now()}re.L.set.call(this,a,b)};
re.prototype.i=function(a){var b=re.L.i.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<Date.now()||c&&c>Date.now())re.prototype.remove.call(this,a);else return b}};function se(){}
;function te(){}
F(te,se);te.prototype[Symbol.iterator]=function(){return jd(this.I(!0)).i()};
...
n.I=function(a){var b=0,c=this.h,d=new id;d.h=function(){if(b>=c.length)throw hd;var e=c.key(b++);if(a)return e;e=c.getItem(e);if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
...
n.I=function(a){var b=0,c=this.h.XMLDocument.documentElement.attributes,d=new id;d.h=function(){if(b>=c.length)throw hd;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
d.next=d.h.bind(d);return d};
...
Be.prototype.I=function(a){var b=this.i.I(!0),c=this,d=new id;d.h=function(){for(var e=b.h();e.substr(0,c.h.length)!=c.h;)e=b.h();return a?e.substr(c.h.length):c.i.get(e)};
...
function hg(){return{innertubeApiKey:Q("INNERTUBE_API_KEY",void 0),innertubeApiVersion:Q("INNERTUBE_API_VERSION",void 0),fb:Q("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),gb:Q("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:Q("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),ib:Q("INNERTUBE_CONTEXT_HL",void 0),hb:Q("INNERTUBE_CONTEXT_GL",void 0),jb:Q("INNERTUBE_HOST_OVERRIDE",void 0)||"",lb:!!Q("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),kb:!!Q("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:Q("SERIALIZED_CLIENT_CONFIG_DATA",void 0)}}
function gg(a){var b={client:{hl:a.ib,gl:a.hb,clientName:a.gb,clientVersion:a.innertubeContextClientVersion,configInfo:a.fb}};navigator.userAgent&&(b.client.userAgent=String(navigator.userAgent));var c=A.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=Q("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=[];var d=Q("EXPERIMENTS_FORCED_FLAGS",{});for(e in d)c.push({key:e,value:String(d[e])});var e=Q("EXPERIMENT_FLAGS",{});for(var f in e)f.startsWith("force_")&&void 0===
d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});f=b.client.clientName;if("WEB"===f||"MWEB"===f||1===f||2===f){if(!R("web_include_display_mode_killswitch")){var g;b.client.mainAppWebInfo=null!=(g=b.client.mainAppWebInfo)?g:{};b.client.mainAppWebInfo.webDisplayMode=mg()}}else if(g=b.client.clientName,("WEB_REMIX"===g||76===g)&&!R("music_web_display_mode_killswitch")){var h;b.client.Ja=null!=(h=b.client.Ja)?h:{};b.client.Ja.webDisplayMode=mg()}a.appInstallData&&
...
function rg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Eb||Q("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().Db:b=Hc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
tg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.h)try{this.h.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Ud(b))}catch(f){return}else e=escape(b);b=this.i;Ec.set(""+a,e,{qa:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
...
v(U,Hg);function Rg(a){U.call(this,"MISSING_OBJECT_STORE",{nb:a},Mg.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Rg.prototype)}
...
V.all=function(a){return new V(new Yg(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={S:0};f.S<a.length;f={S:f.S},++f.S)Zg(V.resolve(a[f.S]).then(function(g){return function(h){d[g.S]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})}))};
...
n=fh.prototype;n.add=function(a,b,c){return X(this,[a],{mode:"readwrite",F:!0},function(d){return d.objectStore(a).add(b,c)})};
...
function ih(a,b){return X(a,["LogsRequestsStore"],{mode:"readwrite",F:!0},function(c){c=c.objectStore("LogsRequestsStore");return W(c.h.put(b,void 0))})}
n.objectStoreNames=function(){return Array.from(this.h.objectStoreNames)};
function X(a,b,c,d){return J(a,function f(){var g=this,h,k,l,m,q,r,p,x,D,w,L,P;return z(f,function(G){switch(G.h){case 1:var O={mode:"readonly",F:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?O.mode=c:Object.assign(O,c);h=O;g.transactionCount++;k=h.F?3:1;l=0;case 2:if(m){G.s(3);break}l++;q=Math.round(S());ra(G,4);r=g.h.transaction(b,h.mode);O=new jh(r);O=kh(O,d);return y(G,O,6);case 6:return p=G.i,x=Math.round(S()),lh(g,q,x,l,void 0,b.join(),h),G.return(p);case 4:D=sa(G);w=Math.round(S());
...
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,l=c.qb,m=c.upgrade,q=c.closed,r;g.addEventListener("upgradeneeded",function(p){try{if(null===p.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");p.dataLoss&&"none"!==p.dataLoss&&Gg("IDB_DATA_CORRUPTED",{reason:p.dataLossMessage||"unknown reason",dbName:Lg(a)});var x=f(),D=new jh(g.transaction);
...
wh.prototype.open=function(){function a(){return J(c,function g(){var h=this,k,l,m,q,r;return z(g,function(p){switch(p.h){case 1:return ra(p,2),y(p,h.i(h.name,h.options.version,e),4);case 4:k=p.i;a:{var x=h.options;for(var D=u(Object.keys(x.ka)),w=D.next();!w.done;w=D.next()){w=w.value;var L=x.ka[w],P=void 0===L.pb?Number.MAX_VALUE:L.pb;if(k.h.version>=L.oa&&!(k.h.version>=P)&&!k.h.objectStoreNames.contains(w)){x=w;break a}}x=void 0}l=x;if(void 0===l){p.s(5);break}if(h.j){p.s(6);break}h.j=!0;return y(p,
h.delete(),7);case 7:return Fg(new U("DB_DELETED_BY_MISSING_OBJECT_STORE",{dbName:h.name,nb:l})),p.return(a());case 6:throw new Rg(l);case 5:return p.return(k);case 2:m=sa(p);if(m instanceof DOMException?"VersionError"!==m.name:"DOMError"in self&&m instanceof DOMError?"VersionError"!==m.name:!(m instanceof Object&&"message"in m)||"An attempt was made to open a database using a lower version than the existing version."!==m.message){p.s(8);break}return y(p,h.i(h.name,void 0,Object.assign(Object.assign({},
...
closed:b,qb:b,upgrade:this.options.upgrade};return this.h=d=a()};var yh=new wh("YtIdbMeta",{ka:{databases:{oa:1}},upgrade:function(a,b){b(1)&&gh(a,"databases",{keyPath:"actualName"})}});
function zh(a){return J(this,function c(){var d;return z(c,function(e){if(1==e.h)return y(e,yh.open(),2);d=e.i;return e.return(X(d,["databases"],{F:!0,mode:"readwrite"},function(f){var g=f.objectStore("databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier:1)return W(g.h.put(a,void 0)).then(function(){})})}))})})}
...
function Bh(a){return J(this,function c(){var d,e;return z(c,function(f){return 1==f.h?(d=[],y(f,yh.open(),2)):3!=f.h?(e=f.i,y(f,X(e,["databases"],{F:!0,mode:"readonly"},function(g){d.length=0;return oh(g.objectStore("databases"),{},function(h){a(h.cursor.value)&&d.push(h.cursor.value);return h.continue()})}),3)):f.return(d)})})}
...
function Zh(a){return J(this,function c(){var d;return z(c,function(e){if(1==e.h)return y(e,Uh().open(),2);d=e.i;return e.return(X(d,["LogsRequestsStore"],{mode:"readwrite",F:!0},function(f){var g=f.objectStore("LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",h.sendCount+=1,W(g.h.put(h,void 0)).then(function(){return h})):V.resolve(void 0)})}))})})}
...
;var ji=ff("network_polling_interval",3E4);function Y(){M.call(this);this.H=0;this.T=this.l=!1;this.i=this.pa();ki(this);li(this)}
...
n.P=function(a,b){a!==this.i&&((void 0===b?0:b)?this.K():this.i=a)};
n.ob=function(a){this.l=!0;if(void 0===a?0:a)this.H||ni(this)};
n.pa=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
n.eb=function(){this.T=!0};
n.W=function(a,b){return M.prototype.W.call(this,a,b)};
function li(a){window.addEventListener("online",function(){return J(a,function c(){var d=this;return z(c,function(e){if(1==e.h)return y(e,d.K(),2);if(d.T&&R("offline_error_handling")){var f=hi().get("errors",!0);if(f){for(var g in f)if(f[g]){var h=new Hg(g,"sent via offline_errors");h.name=f[g].name;h.stack=f[g].stack;h.level=f[g].level;Ke(h)}hi().set("errors",{},2592E3,!0)}}e.h=0})})})}
function ki(a){window.addEventListener("offline",function(){return J(a,function c(){var d=this;return z(c,function(e){return y(e,d.K(),0)})})})}
function ni(a){a.H=hf(function(){return J(a,function c(){var d=this;return z(c,function(e){if(1==e.h)return d.i?d.pa()||!d.l?e.s(3):y(e,d.K(),3):y(e,d.K(),3);ni(d);e.h=0})})},ji)}
n.K=function(a){var b=this;return this.o?this.o:this.o=new Promise(function(c){return J(b,function e(){var f,g,h,k=this;return z(e,function(l){switch(l.h){case 1:return f=window.AbortController?new window.AbortController:void 0,g=null===f||void 0===f?void 0:f.signal,h=!1,ra(l,2,3),f&&(k.v=kf(function(){f.abort()},a||2E4)),y(l,fetch("/generate_204",{method:"HEAD",
...
Y.prototype.sendNetworkCheckRequest=Y.prototype.K;Y.prototype.listen=Y.prototype.W;Y.prototype.enableErrorFlushing=Y.prototype.eb;Y.prototype.getWindowStatus=Y.prototype.pa;Y.prototype.monitorNetworkStatusChange=Y.prototype.ob;Y.prototype.networkStatusHint=Y.prototype.P;Y.prototype.isNetworkAvailable=Y.prototype.D;Y.getInstance=mi;function oi(a){a=void 0===a?{}:a;M.call(this);var b=this;this.l=this.v=0;this.i=mi();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.i);c&&c(a.Ba);a.Ia&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.i))a.ma?(this.ma=a.ma,c("ytnetworkstatus-online",function(){pi(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){pi(b,"publicytnetworkstatus-offline")})):
...
v(oi,M);oi.prototype.D=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable").bind(this.i);return a?a():!0};
oi.prototype.P=function(a,b){b=void 0===b?!1:b;var c=B("yt.networkStatusManager.instance.networkStatusHint").bind(this.i);c&&c(a,b)};
oi.prototype.K=function(a){return J(this,function c(){var d=this,e;return z(c,function(f){return(e=B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(d.i))?f.return(e(a)):f.return(!0)})})};
function pi(a,b){a.ma?a.l?(nf(a.v),a.v=kf(function(){a.o!==b&&(Sd(a,b),a.o=b,a.l=S())},a.ma-(S()-a.l))):(Sd(a,b),a.o=b,a.l=S()):Sd(a,b)}
;var qi=0,ri=0,si,ti=A.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:!1,databaseToken:void 0,potentialEsfErrorCounter:ri,isIdbSupported:!1};E("ytNetworklessLoggingInitializationOptions",ti);function ui(a,b){function c(d){var e=vi().D();if(!wi()||!d||e&&R("vss_networkless_bypass_write"))xi(a,b);else{var f={url:a,options:b,timestamp:S(),status:"NEW",sendCount:0};Vh(f,d).then(function(g){f.id=g;vi().D()&&yi(f)}).catch(function(g){yi(f);
vi().D()?Ke(g):ii(g)})}}
...
e.options.onSuccess=function(h,k){void 0!==e.id?$h(e.id,d):f=!0;R("vss_network_hint")&&vi().P(!0);g(h,k)};
xi(e.url,e.options);Vh(e,d).then(function(h){e.id=h;f&&$h(e.id,d)}).catch(function(h){vi().D()?Ke(h):ii(h)})}else xi(a,b)}
b=void 0===b?{}:b;R("skip_is_supported_killswitch")?Hh().then(function(d){c(d)}):c(zi())}
...
a.options.onError=function(f,g){return J(b,function k(){return z(k,function(l){switch(l.h){case 1:if(!((B("ytNetworklessLoggingInitializationOptions")?ti.potentialEsfErrorCounter:ri)<=ff("potential_esf_error_limit",10))){l.s(2);break}return y(l,vi().K(),3);case 3:if(vi().D())B("ytNetworklessLoggingInitializationOptions")&&ti.potentialEsfErrorCounter++,ri++;else return d(f,g),l.return();case 2:if(void 0===(null===a||void 0===a?void 0:a.id)){l.s(4);break}return 1>a.sendCount?y(l,Zh(a.id,c),8):y(l,$h(a.id,
c),4);case 8:kf(function(){vi().D()&&Bi()},5E3);
case 4:d(f,g),l.h=0}})})};
var e=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(f,g){return J(b,function k(){return z(k,function(l){if(1==l.h)return void 0===(null===a||void 0===a?void 0:a.id)?l.s(2):y(l,$h(a.id,c),2);R("vss_network_hint")&&vi().P(!0);e(f,g);l.h=0})})};
return a}
function vi(){si||(si=new oi({Ia:!0,Ba:!0}));return si}
...
this.V=function(){};
this.now=Date.now;this.Sa=null!==(b=a.Sa)&&void 0!==b?b:100;this.Qa=null!==(c=a.Qa)&&void 0!==c?c:1;this.Na=null!==(d=a.Na)&&void 0!==d?d:2592E6;this.Ma=null!==(e=a.Ma)&&void 0!==e?e:12E4;this.Pa=null!==(f=a.Pa)&&void 0!==f?f:5E3;this.databaseToken=null!==(g=a.databaseToken)&&void 0!==g?g:void 0;this.ia=!!a.ia;this.ga=null!==(h=a.ga)&&void 0!==h?h:.1;this.va=null!==(k=a.va)&&void 0!==k?k:10;a.handleError&&(this.handleError=a.handleError);a.V&&(this.V=a.V);this.G=a.G;this.Ha=a.Ha;this.A=a.A;this.B=
a.B;this.R=a.R;this.ta=a.ta;this.sa=a.sa;this.databaseToken&&(!this.G||this.G("networkless_logging"))&&Ei(this)}
function Ei(a){J(a,function c(){var d=this;return z(c,function(e){if(!d.databaseToken)return e.return();Fi(d);d.B.D()&&d.ca();d.B.W(d.ta,d.ca.bind(d));d.B.W(d.sa,d.ya.bind(d));d.h=!0;return d.ia&&Math.random()<=d.ga?y(e,d.A.bb(d.databaseToken),0):e.s(0)})})}
n=Di.prototype;n.writeThenSend=function(a,b){var c=this;b=void 0===b?{}:b;if(this.databaseToken&&this.h){var d={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0};this.A.set(d,this.databaseToken).then(function(e){d.id=e;c.B.D()&&Gi(c,d)}).catch(function(e){Gi(c,d);
Hi(c,e)})}else this.R(a,b)};
n.sendThenWrite=function(a,b,c){var d=this;b=void 0===b?{}:b;if(this.databaseToken&&this.h){var e={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0};this.G&&this.G("nwl_skip_retry")&&(e.skipRetry=c);if(this.B.D()){if(!e.skipRetry){var f=b.onError?b.onError:function(){};
...
f(g,h);r.h=0})})}}this.R(a,b,e.skipRetry)}else this.A.set(e,this.databaseToken).catch(function(g){Hi(d,g)})}else this.R(a,b,this.G&&this.G("nwl_skip_retry")&&c)};
...
d.options.onSuccess=function(g,h){void 0!==d.id?c.A.U(d.id,c.databaseToken):e=!0;c.B.P&&c.G&&c.G("vss_network_hint")&&c.B.P(!0);f(g,h)};
this.R(d.url,d.options);this.A.set(d,this.databaseToken).then(function(g){d.id=g;e&&c.A.U(d.id,c.databaseToken)}).catch(function(g){Hi(c,g)})}else this.R(a,b)};
n.ca=function(){var a=this;if(!this.databaseToken)throw Vg("throttleSend");this.i||(this.i=kf(function(){return J(a,function c(){var d=this,e;return z(c,function(f){if(1==f.h)return y(f,d.A.Ea("NEW",d.databaseToken),2);if(3!=f.h)return e=f.i,e?y(f,Gi(d,e),3):(d.ya(),f.return());d.i&&(d.i=0,d.ca());f.h=0})})},this.Sa))};
n.ya=function(){nf(this.i);this.i=0};
function Gi(a,b){return J(a,function d(){var e=this,f,g;return z(d,function(h){switch(h.h){case 1:if(!e.databaseToken)throw f=Vg("immediateSend"),f;if(void 0===b.id){h.s(2);break}return y(h,e.A.mb(b.id,e.databaseToken),3);case 3:(g=h.i)?b=g:e.V(Error("The request cannot be found in the database."));case 2:if(Ii(e,b,e.Na)){h.s(4);break}e.V(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){h.s(5);break}return y(h,e.A.U(b.id,e.databaseToken),5);case 5:return h.return();
case 4:b.skipRetry||(b=Ji(e,b));if(!b){h.s(0);break}if(!b.skipRetry||void 0===b.id){h.s(8);break}return y(h,e.A.U(b.id,e.databaseToken),8);case 8:e.R(b.url,b.options,!!b.skipRetry),h.h=0}})})}
function Ji(a,b){if(!a.databaseToken)throw Vg("updateRequestHandlers");var c=b.options.onError?b.options.onError:function(){};
b.options.onError=function(e,f){return J(a,function h(){var k=this,l;return z(h,function(m){switch(m.h){case 1:l=k;if(!(k.potentialEsfErrorCounter<=k.va)){m.s(2);break}if(!k.B.K){m.s(3);break}return y(m,k.B.K(),3);case 3:if(k.B.D())k.potentialEsfErrorCounter++;else return c(e,f),m.return();case 2:if(void 0===(null===b||void 0===b?void 0:b.id)){m.s(5);break}return b.sendCount<k.Qa?y(m,k.A.Oa(b.id,k.databaseToken),9):y(m,k.A.U(b.id,k.databaseToken),5);case 9:kf(function(){l.B.D()&&l.ca()},k.Pa);
case 5:c(e,f),m.h=0}})})};
var d=b.options.onSuccess?b.options.onSuccess:function(){};
b.options.onSuccess=function(e,f){return J(a,function h(){var k=this;return z(h,function(l){if(1==l.h)return void 0===(null===b||void 0===b?void 0:b.id)?l.s(2):y(l,k.A.U(b.id,k.databaseToken),2);k.B.P&&k.G&&k.G("vss_network_hint")&&k.B.P(!0);d(e,f);l.h=0})})};
return b}
function Ii(a,b,c){b=b.timestamp;return a.now()-b>=c?!1:!0}
function Fi(a){if(!a.databaseToken)throw Vg("retryQueuedRequests");a.A.Ea("QUEUED",a.databaseToken).then(function(b){b&&!Ii(a,b,a.Ma)?kf(function(){return J(a,function d(){var e=this;return z(d,function(f){if(1==f.h)return void 0===b.id?f.s(2):y(f,e.A.Oa(b.id,e.databaseToken),2);Fi(e);f.h=0})})}):a.B.D()&&a.ca()})}
function Hi(a,b){a.Ta&&!a.B.D()?a.Ta(b):a.handleError(b)}
;function Ki(){Di.call(this,{A:{bb:ai,U:$h,Ea:Xh,mb:Yh,Oa:Zh,set:Vh},B:new oi({Ia:!0,Ba:!0}),handleError:Ke,V:Le,R:Li,now:S,Ta:ii,Ha:mf(),ta:"publicytnetworkstatus-online",sa:"publicytnetworkstatus-offline",ia:R("enable_nwl_cleaning_logic"),ga:ff("nwl_cleaning_rate",.1),va:ff("potential_esf_error_limit",10),G:R});this.ia&&Math.random()<=this.ga&&this.databaseToken&&ei();R("networkless_immediately_drop_sw_health_store")&&Mi(this);R("networkless_immediately_drop_all_requests")&&bi();Ph("LogsDatabaseV2")}
...
c.onFetchSuccess=function(w,L){xg(p);D(w,L)}}try{r&&d.retry&&!d.Ka.bypassNetworkless?(g.method="POST",d.Ka.writeThenSend?R("use_new_nwl")?Ni().writeThenSend(q,g):ui(q,g):R("use_new_nwl")?Ni().sendAndWrite(q,g):Ai(q,g)):(g.method="POST",g.postParams||(g.postParams={}),xf(q,g))}catch(w){if("InvalidAccessError"==w.name)p&&(xg(p),p=0),Le(Error("An extension is blocking network request."));
...
la:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var Si={O:[],N:[{Za:Ri,weight:500}]};function Ri(a){a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function Ti(){this.N=[];this.O=[]}
var Ui;function Vi(){if(!Ui){var a=Ui=new Ti;a.O.length=0;a.N.length=0;Si.O&&a.O.push.apply(a.O,Si.O);Si.N&&a.N.push.apply(a.N,Si.N)}return Ui}
...
function oj(a,b){for(var c=1;c<arguments.length;++c);le.X.apply(le,arguments)}
...
function qj(a,b,c){rj||(rj={},Te(window,"message",function(d){a:{if(d.origin===Z(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=rj[e.id])d.u=!0,d.u&&(H(d.o,d.sendMessage,d),d.o.length=0),d.xa(e)}e=void 0}return e}));
rj[c]=b}
var rj=null;function sj(a,b,c){this.m=this.h=this.i=null;this.j=0;this.u=!1;this.o=[];this.l=null;this.H={};if(!a)throw Error("YouTube player element ID required.");this.id=Ha(this);this.v=c;this.setup(a,b)}
n=sj.prototype;n.setSize=function(a,b){this.h.width=a.toString();this.h.height=b.toString();return this};
n.Ya=function(){return this.h};
n.xa=function(a){tj(this,a.event,a)};
...
b.toString());var g=a.Aa();g.enablejsapi=window.postMessage?1:0;window.location.host&&(g.origin=window.location.protocol+"//"+window.location.host);g.widgetid=a.id;window.location.href&&H(["debugjs","debugcss"],function(h){var k=Lb(window.location.href,h);null!==k&&(g[h]=k)});
...
n.La=function(){this.h&&this.h.contentWindow?this.sendMessage({event:"listening"}):window.clearInterval(this.j)};
function yj(a){qj(a.i,a,a.id);a.j=Ve(a.La.bind(a));Te(a.h,"load",function(){window.clearInterval(a.j);a.j=Ve(a.La.bind(a))})}
...
vj(this,e)}};
function uj(a,b){a.H[b]||(a.H[b]=!0,wj(a,"addEventListener",[b]))}
...
g,k,r),500<=r);g++);navigator.vendor&&!k.hasOwnProperty("vendor")&&(k["device.vendor"]=navigator.vendor);g={message:f,name:h,lineNumber:q,fileName:l,stack:m,params:k,sampleWeight:1};f=Number(e.columnNumber);isNaN(f)||(g.lineNumber=g.lineNumber+":"+f);if("IGNORED"===e.level)e=0;else a:{e=Vi();f=u(e.O);for(h=f.next();!h.done;h=f.next())if(h=h.value,g.message&&g.message.match(h.Ib)){e=h.weight;break a}e=u(e.N);for(f=e.next();!f.done;f=e.next())if(f=f.value,f.Za(g)){e=f.weight;break a}e=1}g.sampleWeight=
e;e=g;g=u(Qi);for(f=g.next();!f.done;f=g.next())if(f=f.value,f.la[e.name])for(q=u(f.la[e.name]),h=q.next();!h.done;h=q.next())if(l=h.value,h=e.message.match(l.regexp)){e.params["params.error.original"]=h[0];q=l.groups;l={};for(m=0;m<q.length;m++)l[q[m]]=h[m+1],e.params["params.error."+q[m]]=h[m+1];e.message=f.ra(l);break}e.params||(e.params={});g=Vi();e.params["params.errorServiceSignature"]="msg="+g.O.length+"&cb="+g.N.length;e.params["params.serviceWorker"]="false";A.document&&A.document.querySelectorAll&&
(e.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));gb("sample").constructor!==eb&&(e.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(e);if(0!==e.sampleWeight&&!bj.has(e.message)){"ERROR"===d?(Wi.X("handleError",e),R("record_app_crashed_web")&&0===ej&&1===e.sampleWeight&&(ej++,Pi("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),dj++):"WARNING"===d&&Wi.X("handleWarning",e);if(R("kevlar_gel_error_routing")){g=
...
;function Bj(a,b){sj.call(this,a,Object.assign({title:"video player",videoId:"",width:640,height:360},b||{}),"player");this.J={};this.playerInfo={}}
v(Bj,sj);n=Bj.prototype;n.Aa=function(){var a=Z(this.i,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=Z(this.i,"embedConfig")){if(C(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
n.xa=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(C(a))for(var c in a)a.hasOwnProperty(c)&&(this.J[c]=a[c]);break;case "infoDelivery":Cj(this,a);break;case "initialDelivery":C(a)&&(window.clearInterval(this.j),this.playerInfo={},this.J={},Dj(this,a.apiInterface),Cj(this,a));break;default:tj(this,b,a)}};
...
this.J={};wj(this,c,arguments);return this}:Aj(c)?this[c]=function(){var d=0;
...
n.getOptions=function(a){return this.J.namespaces?a?this.J[a]?this.J[a].options||[]:[]:this.J.namespaces||[]:[]};
n.getOption=function(a,b){if(this.J.namespaces&&a&&b&&this.J[a])return this.J[a][b]};
